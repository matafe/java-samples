...
public abstract class CollectionUtils {
  ...
  /**
   * Returns a new list with inner lists with max elements on the inner list as defined on parameter
   * <code>maxsize</code>.
   * 
   * @param collection The collection to be splitted.
   * @param maxsize The max size of element on each inner list.
   * 
